...
public class Bullet : MonoBehaviour
{
    ...
    // FixedUpdate adalah update yang lebih konsisten jeda pemanggilannya cocok digunakan jika katakter mememiliki Physic(Rigitbody,dll)
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.Equals(_targetEnemy.gameObject))
        {
            ...
            // Bullet yang hanya singel target
            else
            {
