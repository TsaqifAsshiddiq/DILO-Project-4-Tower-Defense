...
public class LevelManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Time.unsclaedDeltaTime adalah deltaTime yang independent, tidak terpengaruh oleh apapun kecuali game object itu sendiri, jadi bisa digunakan sebagai penghitung waktu
        ...
        // Jika menekan tombolR, fungsi restart akan terpanggil
    ...
    private void SpawnEnemy()
    {
        ...
        if (_enemyCounter < 0)
        {
            bool isAllEnemyDesroyed = _spawnedEnemies.Find(e => e.gameObject.activeSelf) == null;
            if (isAllEnemyDesroyed)
            {
                SetGameOver(true);
            }
            return;
    ...
    {
        // Mathf.Max berfungsi mengambil angka terbesar
